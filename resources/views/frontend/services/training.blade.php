...
<main id="main">
    ...
    <x-hero-section image="/assets/frontend/img/slide/slide-2.jpg" title="Training Programs" sub-title="Expand the knowledge base of your employees

    Goal-oriented training designed to ensure cost and time are properly invested in other to increase employees knowledge base and performance at work" />
