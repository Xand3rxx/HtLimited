											...
											<div class="menu-edit ">
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<div class="menu-item-actions description-wide submitbox">
																		...
																		<span class="meta-sep hide-if-no-js"> | </span>
																		<a onclick="getmenus()" class="btn btn-primary updatemenu" id="update-{{$m->id}}" href="javascript:void(0)">Update item</a>
												...
												<div id="nav-menu-footer">
													<div class="major-publishing-actions">
														...
														@elseif(request()->has("menu"))
														<span class="delete-action"> <a class="btn btn-danger submitdelete deletion menu-delete" onclick="deletemenu()" href="javascript:void(9)">Delete menu</a> </span>
														<div class="publishing-action">
