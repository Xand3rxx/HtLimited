...
@section('title', 'Training: Business Continuity Plan')
@section('content')
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="page-title">
                        <h5>Training</h5>
                        <h6 class="sub-heading">This page displays a list of all participants who registered for the "Business Continuity Plan" training.</h6>
                    </div>
                </div>
    ...
    <div class="main-content">
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">List of registered Business Continuity Plan participants</div>
                    <div class="card-body">
